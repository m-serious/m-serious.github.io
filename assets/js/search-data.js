...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=17f5_L4AAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/m-serious", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://huggingface.co/m-serious", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/xwzliuzijia", "_blank");
        },
      },{
      id: 'light-theme',
